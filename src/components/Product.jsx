    ...
    <article className="flex flex-col bShadow rounded-lg w-full h-full">
      ...
      <div className="flex flex-col h-full justify-between rounded-b-lg bg-slate-100">
        <div className="px-4 py-2">
          <p className="my-2 font-merriweather font-bold text-xl">{title}</p>
        ...
        <div className="m-2 text-right">
          <button className="w-10 h-10 rounded-full font-quicksand font-bold text-xl bg-amber-400 truncate active:-translate-x-0.5 active:translate-y-0.5">
            +
          </button>
        </div>
      </div>
